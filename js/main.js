...
class ParticleAnimation {
    constructor(el, { quantity = 150, staticity = 50, ease = 50, ballcolor  = '245, 158, 11' } = {}) {
        this.canvas = el;
    ...
    drawCircle(circle, update = false) {
        ...
        this.context.arc(x, y, size, 0, 6 * Math.PI);
        this.context.fillStyle = `rgba(${this.settings.ballcolor}, ${alpha})`;
        // this.context.fillStyle = `rgba(245, 158, 11, ${alpha})`;
        this.context.fill();
...
canvasElements.forEach(canvas => {
    const options = {
        ...
        ballcolor: canvas.dataset.particleBallcolor,
    };
